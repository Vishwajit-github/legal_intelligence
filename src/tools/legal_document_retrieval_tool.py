...
# =========================================================
@tool
def contract_document_retrieval_tool(pdf_path: str, concise_user_query: str):

    """
    Legal Document Intelligence Tool.

    This tool processes legal PDFs and extracts relevant text or structured content.
    ...
    concise_user_query : str
        User query with supporting details, inside 1-1.5 line ONLY.
    ...
    - You need full document extraction
    - You need chunk-based retrieval for large legal files
    - You need evidence-grounded legal analysis
    - You need clause extraction or contract understanding support
